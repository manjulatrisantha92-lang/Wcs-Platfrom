      ...
      <div className="bg-slate-900 border border-slate-700/80 rounded-3xl max-w-2xl w-full overflow-hidden shadow-2xl text-slate-100 animate-in fade-in zoom-in-95 duration-200 flex flex-col max-h-[94vh]">
        ...
        <div className="flex border-b border-slate-800 bg-slate-950/60 text-xs font-semibold">
          ...
          >
            ...
            <span>Activate with License</span>
          </button>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      placeholder="Enter HQ master password manually (optional)"
                      className="w-full bg-slate-950 border border-amber-500/50 rounded-xl pl-9 pr-10 py-2.5 text-xs text-slate-200 focus:outline-hidden focus:border-amber-400 font-mono"
                    />
                    <button
                      type="button"
                      onClick={() => setShowPassword(!showPassword)}
