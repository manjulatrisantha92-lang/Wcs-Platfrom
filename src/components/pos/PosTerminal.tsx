                ...
                <div className="flex flex-wrap items-center justify-between gap-2">
                  ...
                  <div className="flex items-center gap-1.5">
                    ...
                    <select
                      ...
                      className="bg-slate-950 border border-slate-700 text-slate-200 text-[11px] rounded-lg px-2 py-1.5 focus:border-amber-400 focus:outline-hidden"
                    >
                      <option value="">Choose Customer...</option>
                      {customers.map((c) => (
                        <option key={c.id} value={c.id}>
                          {c.name} ({c.phone}) - Bal: {currencySymbol} {(c.current_balance || 0).toLocaleString()}
                        </option>
                      ))}
                    </select>
                    ...
                    <button
                      ...
                      className="px-2.5 py-1.5 bg-amber-500/20 hover:bg-amber-500/30 text-amber-400 border border-amber-500/40 rounded-lg text-[11px] font-bold transition-colors shrink-0"
                    >
